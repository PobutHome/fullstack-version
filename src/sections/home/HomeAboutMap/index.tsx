...
export function HomeAboutMap() {
  return (
    <Section id="about" aria-labelledby="home-about-title">
      <Container className="gap-layout-gap-2">
        <h1
                id="home-about-title"
                className={[
        ...
        <InnerSection
          ...
          <div className="min-w-0 grid gap-space-10">
            ...
            <p className="m-0 text-sys-text pobut-body">
              Компанія &quot;Pobut Home&quot; працює на ринку з 2010 року. Ми пропонуємо широкий
              асортимент побутової хімії, пакувальних та витратних матеріалів, господарських товарів,
              одноразового посуду, серветок, туалетного паперу та продукції для дому, офісу,
              магазинів, кафе, ресторанів і медичних закладів.
            </p>
            <p className="m-0 text-sys-text pobut-body">
              У нашому каталозі представлені вироби від провідних світових брендів та продукція
              власної торгової марки &quot;Pobut Home&quot;, що поєднує високу якість і доступну
              ціну. Наша місія — зробити побут зручнішим, приємнішим і ефективнішим, забезпечуючи
              кожного клієнта надійними товарами для щоденного використання.
            </p>
            <p className="m-0 text-sys-text pobut-body">
          ...
          <div className="min-w-0 grid gap-layout-gap-2">
            ...
            <div className="grid gap-layout-gap-2 sm:grid-cols-2">
              ...
              <div className="min-w-0 grid gap-space-10">
                ...
                <p className="m-0 text-sys-text pobut-body">
                  ТОВ &quot;Pobut Home&quot;, 29000, Хмельницька обл., м. Хмельницький, вул. Деповська,
                  19/2
                </p>
              </div>
            </div>
